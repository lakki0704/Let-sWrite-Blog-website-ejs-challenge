...
var posts = []; //creating an empty array to store the blogs 
...
app.get("/posts/:postname", function(req, res) {
    ...
    posts.forEach(function(post) {
        ...
        if (storedfile === requested) {
            console.log("Match found!!");
            res.render("post.ejs", { Title: requested, Content: storedblog });
        }

    });
    //dynamic website or dynamic link
});
